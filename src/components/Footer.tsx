                        ...
                        <div className="flex flex-wrap gap-2">
                            {socialLinks.map((s) => (
                                <a
                                    ...
                                    className="inline-flex items-center gap-1.5 px-3 py-2.5 min-h-11 rounded-full border border-white/10 bg-white/[0.03] text-xs font-semibold text-white/70 hover:text-white hover:border-white/25 hover:bg-white/[0.06] transition-colors"
                                    title={s.handle}
                                >
                                    {socialIcons[s.name]}
                                    {s.name}
