                ...
                >
                    {competencies.map((comp, i) => (
                        ...
                        >
                            ...
                            <span className="font-bold text-gray-200 text-xs sm:text-sm leading-snug tracking-tight group-hover:text-shimmer transition-colors z-10">{comp.name}</span>
                        </motion.div>
                    ))}
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 md:gap-x-12 gap-y-3 sm:gap-y-4">
                            {[
                                ...
                                <div key={idx} className="flex gap-3 sm:gap-4 items-center py-2 border-b border-white/5">
